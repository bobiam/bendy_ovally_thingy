...
int no_one_close()
{
  ...
  polled = chase(randomColor(),randomColor(),random(25,75));
  if(polled == 999)
    saw_motion();        
...
{
  if(fract_segments(c1,c2,15,wait) == 999)
    return 999;  
  if(fract_segments(c1,c2,10,wait) == 999)
    return 999;  
  if(fract_segments(c1,c2,5,wait) == 999)
    return 999;  
  if(fract_segments(c1,c2,3,wait) == 999)
    return 999;  
  if(fract_segments(c1,c2,2,wait) == 999)
    return 999;      
